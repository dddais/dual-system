"""OpenAI-compatible multimodal chat VLM adapter."""
...
from dualsystem.io.image import image_to_openai_content
...
class OpenAICompatibleVLMClient:
    ...
    def generate(self, planner_input: PlannerInput) -> PlannerOutput:
        ...
        return PlannerOutput(
            raw_outputs=[self._extract_content(response_data)],
            raw_response=response_data,
        )

    def _build_payload(self, planner_input: PlannerInput) -> dict[str, Any]:
